...
export default function ApprovalPage() {
  ...
  return (
    <>
      <AppHero eyebrow="Approval required" title={<>Review before <em>execution.</em></>} copy="Review the parsed route intent, deterministic checks, and wallet readiness before using the route panel." />
      <section className="content-grid" aria-labelledby="approval-title">
        <div className="card approval-card">
          ...
          <div className="button-row"><button className="primary-button" disabled type="button">{canApprove ? "Use route panel to execute" : "Route not ready"}</button><Link className="secondary-button" href="/app/agent">Cancel</Link></div>
        </div>
        <RealCctpRoutePanel />
      </section>
    </>
